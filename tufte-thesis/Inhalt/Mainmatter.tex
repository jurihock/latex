...
\begin{figure*}[p]
\fbox{\includegraphics[width=0.45\linewidth]{Abbildungen/vdqi-title.pdf}}
\hfill
\fbox{\includegraphics[width=0.45\linewidth]{Abbildungen/ei-title.pdf}}
\\\vspace{\baselineskip}
\fbox{\includegraphics[width=0.45\linewidth]{Abbildungen/ve-title.pdf}}
\hfill
\fbox{\includegraphics[width=0.45\linewidth]{Abbildungen/be-title.pdf}}
\end{figure*}
...
\fbox{\includegraphics[width=0.45\linewidth]{Abbildungen/vdqi-contents.pdf}}
\hfill
\fbox{\includegraphics[width=0.45\linewidth]{Abbildungen/ei-contents.pdf}}
\\\vspace{\baselineskip}
\fbox{\includegraphics[width=0.45\linewidth]{Abbildungen/ve-contents.pdf}}
\hfill
\fbox{\includegraphics[width=0.45\linewidth]{Abbildungen/be-contents.pdf}}
\end{figure*}
